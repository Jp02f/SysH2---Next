      ...
      <main className="absolute top-[100px] bottom-6 left-6 right-6 z-10 flex flex-col">
        ...
        <div className="border border-zinc-300 rounded-[2.5rem] p-10 w-full h-full flex flex-col bg-transparent">
          ...
          <div className="flex flex-col gap-6">
            {/* Botão 1: Porteiros */}
            <Link href="/sindica/gerenciarporteiros" className="group flex items-center gap-8 bg-white/65 p-10 rounded-[2.5rem] shadow-sm hover:shadow-md transition-all border border-zinc-100 text-left">
            ...
            {/* Botão 2: Moradores */}
            <Link href="/sindica/gerenciarmoradores" className="group flex items-center gap-8 bg-white/65 p-10 rounded-[2.5rem] shadow-sm hover:shadow-md transition-all border border-zinc-100 text-left">
            ...
            {/* Botão 3: Relatórios */}
            <Link href="/sindica/relatorios" className="group flex items-center gap-8 bg-white/65 p-10 rounded-[2.5rem] shadow-sm hover:shadow-md transition-all border border-zinc-100 text-left">
